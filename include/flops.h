...
//==============================================================================================
#define FMULS_DOTPRODUCT(m_) (m_)
#define FADDS_DOTPRODUCT(m_) (m_)
template<class T>
double FLOPS_DOTPRODUCT(int m){
  return (is_complex(T) ? 6. : 1.) * FMULS_DOTPRODUCT((double)(m))
       + (is_complex(T) ? 2. : 1.) * FADDS_DOTPRODUCT((double)(m));
}
...
// template<class T>
// double FLOPS_GEMM_v1(int m, int n, int k){
//   return FLOPS_DGEMM((double)(m), (double)(n), (double)(k));
// }
