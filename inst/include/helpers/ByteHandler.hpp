 ...
 * @brief Implementation of byte manipulation functions for VecchiaGB.
 * @version 1.0.0
...
#ifndef VECCHIAGP_BYTEHANDLER_HPP
#define VECCHIAGP_BYTEHANDLER_HPP
...
#endif //VECCHIAGP_BYTEHANDLER_HPP
