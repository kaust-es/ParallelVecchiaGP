...
#ifndef VECCHIAGP_LOGGER_HPP
#define VECCHIAGP_LOGGER_HPP
...
#define VERBOSE_1(msg) \
    if(vecchia::configurations::Configurations::GetVerbosity() == vecchia::common::Verbose::DETAILED_MODE && \
      !vecchia::helpers::CommunicatorMPI::GetInstance()->GetRank()) { \
 ...
 */
#define LOGGER_1(msg) \
    if(!(vecchia::configurations::Configurations::GetVerbosity() == vecchia::common::Verbose::QUIET_MODE) && !vecchia::helpers::CommunicatorMPI::GetInstance()->GetRank()){ \
        std::ostringstream oss; \
