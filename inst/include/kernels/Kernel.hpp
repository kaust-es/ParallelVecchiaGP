...
#ifndef VECCHIAGP_KERNELS_HPP
#define VECCHIAGP_KERNELS_HPP
...
namespace vecchia::kernels {
    ...
    public:
        ...
        GenerateCovarianceMatrix(double *apMatrixA, const int &aRowsNumber, const int &aColumnsNumber, const int &aRowOffset,
                                 ...
                                 double *apLocalTheta, const int &aDistanceMetric) = 0;
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(Kernel)

}//namespace vecchia

#endif //VECCHIAGP_KERNELS_HPP