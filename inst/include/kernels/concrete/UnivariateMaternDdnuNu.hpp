...
#ifndef VECCHIAGP_UNIVARIATEMATERNDDNUNU_HPP
#define VECCHIAGP_UNIVARIATEMATERNDDNUNU_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Univariate Matern Ddnu Nu kernel.
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternDdnuNu)
}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNDDNUNU_HPP
