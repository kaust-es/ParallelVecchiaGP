...
#ifndef VECCHIAGP_UNIVARIATESPACETIMEMATERNSTATIONARY_HPP
#define VECCHIAGP_UNIVARIATESPACETIMEMATERNSTATIONARY_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Univariate Spacetime Matern Stationary kernel.
    ...
    *
    */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateSpacetimeMaternStationary)
}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATESPACETIMEMATERNSTATIONARY_HPP
