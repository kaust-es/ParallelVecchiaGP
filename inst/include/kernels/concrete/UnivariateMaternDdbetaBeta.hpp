...
#ifndef VECCHIAGP_UNIVARIATEMATERNDDBETABETA_HPP
#define VECCHIAGP_UNIVARIATEMATERNDDBETABETA_HPP
...
namespace vecchia::kernels {
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternDdbetaBeta)

}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNDDBETABETA_HPP
