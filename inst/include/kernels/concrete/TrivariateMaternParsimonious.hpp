...
#ifndef VECCHIAGP_TRIVARIATEMATERNPARSIMONIOUS_HPP
#define VECCHIAGP_TRIVARIATEMATERNPARSIMONIOUS_HPP
...
namespace vecchia::kernels {
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(TrivariateMaternParsimonious)

}//namespace vecchia

#endif //VECCHIAGP_TRIVARIATEMATERNPARSIMONIOUS_HPP
