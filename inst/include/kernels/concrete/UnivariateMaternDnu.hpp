...
#ifndef VECCHIAGP_UNIVARIATEMATERNDNU_HPP
#define VECCHIAGP_UNIVARIATEMATERNDNU_HPP
...
namespace vecchia::kernels {
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternDnu)

}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNDNU_HPP
