...
#ifndef VECCHIAGP_UNIVARIATEEXPNONGAUSSIAN_HPP
#define VECCHIAGP_UNIVARIATEEXPNONGAUSSIAN_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Univariate Exp Non Gaussian kernel.
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateExpNonGaussian)
}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEEXPNONGAUSSIAN_HPP
