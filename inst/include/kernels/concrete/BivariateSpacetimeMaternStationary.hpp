...
#ifndef VECCHIAGP_BIVARIATESPACETIMEMATERNSTATIONARY_HPP
#define VECCHIAGP_BIVARIATESPACETIMEMATERNSTATIONARY_HPP
...
namespace vecchia::kernels {
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(BivariateSpacetimeMaternStationary)
}//namespace vecchia

#endif //VECCHIAGP_BIVARIATESPACETIMEMATERNSTATIONARY_HPP
