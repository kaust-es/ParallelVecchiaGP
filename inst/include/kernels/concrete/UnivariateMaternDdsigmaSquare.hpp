...
#ifndef VECCHIAGP_UNIVARIATEMATERNDDSIGMASQUARE_HPP
#define VECCHIAGP_UNIVARIATEMATERNDDSIGMASQUARE_HPP
...
namespace vecchia::kernels {
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternDdsigmaSquare)

}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNDDSIGMASQUARE_HPP
