...
#ifndef VECCHIAGP_BIVARIATEMATERNPARSIMONIOUS_HPP
#define VECCHIAGP_BIVARIATEMATERNPARSIMONIOUS_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Bivariate Matern Parsimonious kernel.
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(BivariateMaternParsimonious)

}//namespace vecchia

#endif //VECCHIAGP_BIVARIATEMATERNPARSIMONIOUS_HPP
