...
#ifndef VECCHIAGP_BIVARIATEMATERNFLEXIBLE_HPP
#define VECCHIAGP_BIVARIATEMATERNFLEXIBLE_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Bivariate Matern Flexible kernel.
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(BivariateMaternFlexible)
}//namespace vecchia
#endif //VECCHIAGP_BIVARIATEMATERNFLEXIBLE_HPP
