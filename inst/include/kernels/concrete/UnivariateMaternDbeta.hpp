...
#ifndef VECCHIAGP_UNIVARIATEMATERNDBETA_HPP
#define VECCHIAGP_UNIVARIATEMATERNDBETA_HPP
...
namespace vecchia::kernels {
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternDbeta)

}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNDBETA_HPP
