...
#ifndef VECCHIAGP_UNIVARIATEMATERNDDSIGMASQUARENU_HPP
#define VECCHIAGP_UNIVARIATEMATERNDDSIGMASQUARENU_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Univariate Matern Ddsigma Square Nu kernel.
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternDdsigmaSquareNu)

}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNDDSIGMASQUARENU_HPP
