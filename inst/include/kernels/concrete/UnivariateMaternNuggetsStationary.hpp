...
#ifndef VECCHIAGP_UNIVARIATEMATERNNUGGETSSTATIONARY_HPP
#define VECCHIAGP_UNIVARIATEMATERNNUGGETSSTATIONARY_HPP
...
namespace vecchia::kernels {
     ...
     * @brief A class represents a Univariate Matern Nuggets Stationary kernel.
     ...
     *
     */
    VECCHIAGP_INSTANTIATE_CLASS(UnivariateMaternNuggetsStationary)

}//namespace vecchia

#endif //VECCHIAGP_UNIVARIATEMATERNNUGGETSSTATIONARY_HPP
